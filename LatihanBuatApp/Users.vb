...
Public Class Users
    ...
    Public Sub New()
        usersList.Add({"ukino", EncryptData("ukina")})
        usersList.Add({"jordi", EncryptData("ukino")})
        usersList.Add({"abangSaman", EncryptData("mbu")})
        usersList.Add({"jaki", EncryptData("inisialg")})
    End Sub
